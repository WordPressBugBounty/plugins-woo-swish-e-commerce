...
/**
 * This file contains MIT-licensed code from Şerban Ghiţă, Nick Ilyin and contributors.
 * See LICENSE.MIT file for the full MIT license text.
 */
...
class WooSwishMobileDetection
{
     ...
     * @return void
     */
    public function autoInitKnownHttpHeaders()
    {
...
//        }, ARRAY_FILTER_USE_KEY);
    ...
    protected function hasHttpHeader($name)
    {
     ...
     * @return array
     */
    public function getCloudFrontHttpHeaders()
    {
    ...
    public function isUserAgentEmpty()
    {
     ...
     * @return bool
     * @throws WooSwishMobileDetectException
     */
    public function isMobile()
    {
        if (!$this->hasUserAgent()) {
            throw new WooSwishMobileDetectException('No valid user-agent has been set.');
        }
        ...
        if ($this->hasHttpHeaders() && $this->checkHttpHeadersForMobile()) {
            ...
            return $this->matchUserAgentWithFirstFoundMatchingRule();
        }
    }
    ...
    {
        if (!$this->hasUserAgent()) {
            throw new WooSwishMobileDetectException('No user-agent has been set.');
        }
...
//                }
     ...
     * @return bool
     */
    protected function matchUserAgentWithFirstFoundMatchingRule()
    {
     ...
     * @return bool
     */
    protected function matchUserAgentWithRule($ruleName)
    {
        $result = false;
...
class WooSwishMobileDetectException extends \Exception
{
}